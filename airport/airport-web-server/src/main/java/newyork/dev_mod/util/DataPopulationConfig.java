...
import newyork.dbsetup.HibernateSetup;
import newyork.filter.NoDataFilter;
import newyork.ioc.ApplicationServerModule;
import newyork.serialisation.SerialisationClassProvider;
...
/**
 * Provides New York Airport Asset Management specific implementation of {@link IDomainDrivenTestCaseConfiguration} to be used for creation and population of the target development database from within of IDE.
 *
 * @author TG Team
 *
 */
public final class DataPopulationConfig implements IDomainDrivenTestCaseConfiguration {
    ...
    public DataPopulationConfig(final Properties props) {
    	...
    	try {
    	    ...
    	    props.setProperty("app.name", "New York Airport Asset Management");
    	    props.setProperty("reports.path", "");
    	    props.setProperty("domain.path", "../airport-pojo-bl/target/classes");
    	    props.setProperty("domain.package", "newyork");
    	    props.setProperty("tokens.path", "../airport-pojo-bl/target/classes");
    	    props.setProperty("tokens.package", "newyork.security.tokens");
    	    props.setProperty("workflow", "development");
    	    props.setProperty("email.smtp", "mail.newyork.com.ua");
    	    props.setProperty("email.fromAddress", "airport_support@newyork.com.ua");
